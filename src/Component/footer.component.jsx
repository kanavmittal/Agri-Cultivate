        ...
        return (
            <div>
                ...
                <div className="w-full relative">
                    ...
                    <p className="absolute bottom-0 top-16 md:top-32 mr-auto ml-auto left-8 md:left-36 lg:left-60 font-bold md:text-2xl">Sanya Jain</p>
                    <p className="absolute top-0 md:top-3 bottom-0 right-8 md:right-60 lg:right-80 font-bold md:text-2xl">Nidhish Kukreja</p>
                </div>
            </div>
        )
    }
